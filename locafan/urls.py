...
urlpatterns = patterns('',
    ...
    url(r'^clientes/editar/(?P<nome>.+)/$', 'clientes.views.editar_nome', name='clientes_editar_nome'),
    ...
    url(r'^clientes/excluir/(?P<nome>.+)/$', 'clientes.views.excluir_nome', name='clientes_excluir_nome'),
    ...
    url(r'^fantasias/editar/(?P<nome>.+)/$', 'fantasias.views.editar_nome', name='fantasias_editar_nome'),

...
def cadastrar(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'fantasias_form_ok.djhtml', {
                'tarefa': u'Cadastro',
    ...
    return render(request, 'fantasias_form.djhtml', {
        'form': form,
        'tarefa': 'Cadastrar',
        'botao': 'Cadastrar',
    })
...
def editar(request):
    ...
    return render(request, 'fantasias_busca.djhtml', {'tarefa': 'Editar'})
...
def listar(request):
    ...
    return render(request, 'fantasias_lista.djhtml', {'fantasias': fantasias})

def excluir(request):

    return render(request, 'fantasias_busca.djhtml', {'tarefa': 'Excluir'})
